...
func (s *Builder) Init(ctx context.Context, req *builderv0.InitRequest) (*builderv0.InitResponse, error) {
	...
	s.Wool.Debug("init", wool.Field("endpoints proposed", configurations.MakeManyNetworkMappingSummary(req.ProposedNetworkMappings)))
	//
	...
	//			"read":  s.CreateConnectionConfiguration(ctx, readMapping.Address),
	//			"write": s.CreateConnectionConfiguration(ctx, writeMapping.Address),
	//		},
	//	},
	//}
...
func (s *Builder) Deploy(ctx context.Context, req *builderv0.DeploymentRequest) (*builderv0.DeploymentResponse, error) {
	...
	//}
	//
	//envs = append(envs, fmt.Sprintf("%s=%s", writeKey, s.CreateConnectionConfiguration(ctx, writeMapping.Address)))
	//
	...
	//}
	//
	//envs = append(envs, fmt.Sprintf("%s=%s", readKey, s.CreateConnectionConfiguration(ctx, readMapping.Address)))
	//
